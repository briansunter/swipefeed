...
function Wrapper({ onRequestIndexChange }) {
    ...
    return _jsx("div", { "data-testid": "target", ...handlers });
}
describe("useGestures", () => {
    it("requests next index on flick/threshold", () => {
        const onRequestIndexChange = vi.fn();
        const { getByTestId } = render(_jsx(Wrapper, { onRequestIndexChange: onRequestIndexChange }));
