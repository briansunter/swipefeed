...
describe("useSwipeDeck / <SwipeDeck>", () => {
    ...
    it("defaults to initial index 0", () => {
        function Probe() {
            ...
            return _jsx("div", { "data-testid": "probe", "data-index": deck.index });
        }
        render(_jsx(Probe, {}));
    ...
    it("renders items and marks first as active", () => {
        render(_jsx(SwipeDeck, { items: [{ id: "a" }, { id: "b" }, { id: "c" }], children: ({ item, props, isActive }) => (_jsx("div", { ...props, "data-testid": `item-${item.id}`, "data-active": isActive })) }));
