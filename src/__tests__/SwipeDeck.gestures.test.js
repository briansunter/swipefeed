...
describe("SwipeDeck Gestures Integration", () => {
    ...
    it("changes index on vertical swipe", async () => {
        ...
        render(_jsx(SwipeDeck, { items: [{ id: 1 }, { id: 2 }, { id: 3 }], onIndexChange: handleIndexChange, index: 0, children: ({ item }) => _jsxs("div", { "data-testid": `slide-${item.id}`, children: ["Slide ", item.id] }) }));
